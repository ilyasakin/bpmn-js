...
const PORT = 5197;
const outBefore = process.argv[2] || path.join(outDir, 'xyflow-modeler-bends-before.png');
const outAfter  = process.argv[3] || path.join(outDir, 'xyflow-modeler-bends-after.png');
